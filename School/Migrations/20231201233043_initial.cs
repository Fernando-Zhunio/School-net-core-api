    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Parallels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Parallels_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tuition_Periods_PeriodId",
                        column: x => x.PeriodId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Notes_Partials_PartialId",
                        column: x => x.PartialId,
                        principalTable: "Partials",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schedules_Parallels_ParallelId",
                        column: x => x.ParallelId,
                        principalTable: "Parallels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Parallels_CourseId",
                table: "Parallels",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_Schedules_ParallelId",
                table: "Schedules",
                column: "ParallelId");
